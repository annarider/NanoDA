...
subset(companies, revenue2014 > 2000000000)
```
...
ggplot(data = sample_n(subset(companies, revenue2014 < 15000000), 2000), 
       aes(x = revenue2014, y = growth_dollar)) +
    geom_jitter(aes(color = industry_top3)) +
    geom_smooth(aes(color = industry_top3))
    
ggplot(data = companies, 
       aes(x = revenue2014, y = workers)) +
    geom_jitter(aes(color = industry_top3)) +
    geom_smooth(aes(color = industry_top3), method = 'lm')
