...
ggplot(data = state_growth, aes(x = state_population2014, y = state_growth_dollar)) +
    geom_point()
...
cor.test(state_growth$state_population2014, state_growth$state_growth_dollar)
```
...
```{r echo=FALSE, message = FALSE, warnings = FALSE, State_Growth_Dollar_Bivariate_Plots}
ggplot(data = state_growth, aes(x = state_population2014, y = growth_per_capita)) +
    geom_point()
...
cor.test(state_growth$state_population2014, state_growth$growth_per_capita)
```
