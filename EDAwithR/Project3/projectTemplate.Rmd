...
```
The effect of industry on revenue and growth. There isn't much of a consistent trend. The top 3 industries have the densest points but there is no consistent pattern across industries. They all tend towards a positive relationship between revenue and growth in dollars. When employee numbers are added to the plots, the trend supports the previous findings that groups with a smaller number of employees tends to have lower income and lower growth.   
