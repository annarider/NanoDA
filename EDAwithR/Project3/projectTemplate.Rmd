...
companies$rank <- sort(companies$rank, descending = TRUE)
...
companies_matrix_subset <- subset(companies, select = c(-row_num, -id, -company, -url, -state_s))
names(companies_matrix_subset)
library(GGally)
