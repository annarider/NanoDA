...
ggplot(data = sample_n(subset(companies, revenue2014 < 15000000), 1000),
    ...
    geom_smooth(aes(color = industry_tech), method = 'lm')

ggplot(data = sample_n(subset(companies, revenue2014 < 15000000), 1000),
       aes(x = revenue2014, y = growth_dollar)) +
    geom_density2d(aes(color = industry_tech )) +
    scale_color_brewer(type = 'qual') +
    geom_point(aes(color = industry_tech, size = yrs_on_list))

ggplot(data = sample_n(subset(companies, revenue2014 < 15000000 & workers < 1000), 1000),
       aes(x = revenue2014, y = workers, color =  industry_tech)) +
    geom_violin() +
    scale_color_brewer(type = 'qual') +
...
It turns out there is not a noticeable difference in trends between the IT Services industry and all other industries. IT Services follows more or less the same trend when it comes to revenue and growth. 
