...
message("The revenue distribution is really skewed right. 
        A log10 transformation and adjusting bin width will
...
message("Even after a log10 transformation, the data is still skewed 
        to the right. Removing extremely high
        revenue outliers helps show a more normal distribution")
...
The relationship between revenue in 2014 and growth appears to be strongly correlated based on the Pearson's r value, `r cor(revenue2014, growth_percentage)` for revenue2014 and growth_percentage, and `r cor(revenue2014, growth_dollar)` for revenue2014 and growth_dollar.  
...
A highly correlated relationship also exists between revenue in 2013 and growth. However the relationship is weaker than the relationship between revenue in 2014 and growth, which 
