...
```{r echo=FALSE, Multivariate_Recode_Industry_Plots, warning=FALSE}
...
Non-IT industries dominate over IT industries in terms of greater revenue and growth. In the lower levels of revenue and growth (bottom left side), the two industries are competitive and the shape of the distributions are fairly similar. 

```{r Multivariate_State_Industry_Plots}
